...
## 프로젝트 소개
- **프로젝트 구조**: 서버사이드 렌더링(SSR) 방식을 사용하여 구현
- **서비스명**: `WE`와 `METRO`를 결합하여 **WETRO**로 명명
- **프로젝트 기간**: 2023년 10월 ~ 2023년 12월 (2개월)
- **현재 상태**: 운영 비용 문제로 인해 현재는 배포 중단 상태

## 팀 구성 🙋🏻‍♂️
- **프론트엔드 개발자**: 2명 (고건혁 , 최경봉)
- **백엔드 개발자**: 2명 (김현성 , 송정민)

[![](https://avatars.githubusercontent.com/u/122839143?v=4)](https://github.com/evgeniac10) | [![](https://avatars.githubusercontent.com/u/00000000?v=4)](https://github.com/thdwjdals) | [![](https://avatars.githubusercontent.com/u/00000000?v=4)](https://github.com/CoconutGithub) | [![](https://avatars.githubusercontent.com/u/00000000?v=4)](https://github.com/ckb0276) |
| :---: | :---: | :---: | :---: |
| 김현성 | 송정민 | 고건혁 | 최경봉 |
...
- **즐겨찾기**: 자주 사용하는 경로를 즐겨찾기로 저장하여 빠르게 접근 가능 ⭐️
